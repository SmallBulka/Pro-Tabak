...
function Catalog(props) {
  return (
    ...
    <section >
    <div className="relative w-[320px] h-[480px] bg-[#191919] rounded-[20px] overflow-hidden
  ...
  ">
    ...
    <div className="relative container">
        <span className="absolute  text-[7em] font-extrabold italic text-white/10">take</span> 
</div>
