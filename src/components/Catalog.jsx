  ...
  return (
   ...
   card hover:before:top-[-70%] hover:before:transform hover:before:skew-y-[390deg] "
      >
        ...
        <div className="relative p-5 flex justify-center items-center flex-col z-20 cursor-default">
          <h3 className="text-white text-lg lg:text-xl font-medium tracking-wide text-center cursor-default select-none">
            {props.title}
          </h3>

          <div className="relative container">
            <span className="absolute  text-[7em] font-extrabold italic text-white/10 cursor-default select-none">
              take
            </span>
          </div>
          <p
    ...
    bg-[#ffce00] rounded-[30px] uppercase tracking-[1px] transition duration-500  cursor-pointer select-none"
          >
            Где купить?
          </p>
        </div>
